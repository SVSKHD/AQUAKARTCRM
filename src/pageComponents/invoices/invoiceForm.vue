...
const props = defineProps({
  initialInvoice: {
    ...
    default: () => ({
      ...
      gstDetails: { gstName: '', gstNo: '', gstPhone: null, gstEmail: '', gstAddress: '' },
      transport: { deliveredBy: '', deliveryDate: '' },
      products: [{ productName: '', productQuantity: 0, productPrice: 0, productSerialNo: '' }],
      paidStatus: '', aquakartOnlineUser: false, aquakartInvoice: false, paymentType: ''
    })
  }
});
...
watch(() => props.initialInvoice, (newVal) => {
