...
const getAllSubCategories = async () =>
  await axios.get(`${BASE}/all-subcategories`);

const getSubCategory = (id) => axios.get(`${BASE}/subcategory/${id}`);

const EditSubCategory = (id, token, data) =>
  axios.post(
    `${BASE}/subcategory-add/${id}`,
    {
      headers: {
...
const CreateSubCategory = (id, token, data) =>
  axios.put(
    `${BASE}/subcategory-update/${id}`,
    {
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
const DeleteSubCategory = (id, token) =>
  axios.get(`${BASE}/subcategory/delete/${id}`, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  });
